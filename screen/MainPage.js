    ...
    render() {
        ...
        return (
            <View style={{
                ...
                <View style={{
                    height: 200, width: 200, backgroundColor: 'white', shadowColor: '#000', shadowOffset: { width: 0, height: 1 },
                ...
                <View style={{
                    marginTop: 20, height: 200, width: 200, backgroundColor: 'white', shadowColor: '#000', shadowOffset: { width: 0, height: 1 },
                    shadowOpacity: 0.7, shadowRadius: 1, elevation: 1, borderRadius: 20, justifyContent: 'center', flexDirection: 'row'
                }}>
                    <View style={{ justifyContent: 'center' }}>
                        <TouchableOpacity onPress={() => navigate('ManagePost')}>
